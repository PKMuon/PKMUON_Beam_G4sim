...
/*
	if(m_costheta<0)
	{
		...
		cout<<"Pos1 (x,y,z) = "<<Pos1->X()<<" , "<<Pos1->Y()<<" , "<<Pos1->Z()<<endl;
		cout<<"R1 = "<<sqrt(Pos1->X()*Pos1->X()+Pos1->Y()*Pos1->Y())<<endl;
		cout<<"Pos2 (x,y,z) = "<<Pos2->X()<<" , "<<Pos2->Y()<<" , "<<Pos2->Z()<<endl;
		cout<<"R2 = "<<sqrt(Pos2->X()*Pos2->X()+Pos2->Y()*Pos2->Y())<<endl;
		cout<<"Vec_muon (x,y,z) = "<<Vec_muon.Unit().X()<<" , "<<Vec_muon.Unit().Y()<<" , "<<Vec_muon.Unit().Z()<<endl;
		cout<<"GemTrk P1 (x,y,z) = "<<GemTrkPx[0]<<" , "<<GemTrkPy[0]<<" , "<<GemTrkPz[0]<<endl;
		cout<<"GemTrk P2 (x,y,z) = "<<GemTrkPx[1]<<" , "<<GemTrkPy[1]<<" , "<<GemTrkPz[1]<<endl;
	}
*/
